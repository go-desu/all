...
export class Board {
    ...
    constructor(width: number, height: number | null = null) {
        this.width = width;
    ...
    Consider(coord: Coordinate, stone: STONE, ko?: Coordinate): ({success: false, errorMsg: string} | {success: true, captures: Coordinate[], ko?: Coordinate}) {
        const oppType = stone == STONE.BLACK ? STONE.WHITE : STONE.BLACK;
        let captures = [] as Coordinate[];
        const captured = {} as Record<string, boolean>;
